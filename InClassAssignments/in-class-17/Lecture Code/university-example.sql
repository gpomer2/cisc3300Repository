"Create a new database called cisc3300(which I would use for the rest of the course), create a new table for your fictitious company or your final project, insert some data, send a screenshot of a query returning that output."
